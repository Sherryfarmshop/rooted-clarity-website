  ...
  return (
    <section id="supplements" className="bg-[#f7f4ef]">
      <div className="max-w-4xl mx-auto px-6 py-14 sm:py-16">
        ...
        {/* Header */}
        <p className="text-[#8B6914]/60 text-xs uppercase tracking-[0.2em] mb-3">Tools &amp; Supplements</p>
        <h2 className="font-serif text-3xl sm:text-4xl font-bold text-[#1B3A2A] leading-tight mb-3">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-10">
          ...
          <div className="bg-white rounded-2xl border border-[#e5dfd5] shadow-sm p-7 flex flex-col">
            {/* Icon */}
            <div className="flex justify-center mb-5">
              <svg viewBox="0 0 160 140" className="w-32 h-auto" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="30" y="10" width="100" height="110" rx="14" fill="#1B3A2A" />
            ...
            <div className="mt-auto">
              <a
                ...
                className="block w-full text-center bg-[#1B3A2A] text-[#f0ece3] font-semibold px-6 py-3.5 rounded-lg text-sm hover:bg-[#15301f] transition-colors mb-2"
              >
                Learn More
              </a>
          ...
          <div className="bg-white rounded-2xl border border-[#e5dfd5] shadow-sm p-7 flex flex-col">
            ...
            <div className="flex justify-center mb-5">
              <svg viewBox="0 0 160 140" className="w-32 h-auto" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="48" y="28" width="64" height="102" rx="10" fill="#1B3A2A" />
            ...
            <div className="mt-auto">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block w-full text-center bg-[#C9A84C] text-[#1a1a1a] font-semibold px-6 py-3.5 rounded-lg text-sm hover:bg-[#b0873a] transition-colors shadow-md mb-2"
              >
